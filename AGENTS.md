...
Randomly select and display a specified number of members from the current roster without duplicates.
...
I'm using `Fastify` and `Typescript`.
Within this directory, you should make decisions as a Typescript expert.
